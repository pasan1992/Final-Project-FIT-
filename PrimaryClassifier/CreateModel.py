...
# GaussianNBtrain_data_prediction = [gnb.predict(vectorizer.transform([line[1].lower()]).toarray()) for line in train_data]
...
# SVCtrain_data_prediction =clf3.predict(question_vectors)

print ("Train accuracy LogisticRegression" + str(compute_accuracy(train_data_prediction, train_lables)))
...
# print ( cfier.predict(vectorizer.transform( ["how to treat syndrome"]) )  )
#
# cfier.classes_